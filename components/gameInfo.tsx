  ...
  return (
    <div className='w-full relative'>
      <div className="w-full h-full text-center relative"> 
        ...
        <h1 className="relative text-white md:text-left md:ml-80 2xl:ml-[60vh] 2xl:text-[6rem] mt-32 md:mt-0 text-4xl md:text-6xl">{gameInfo[index]?.name}</h1>
        <div className="md:ml-80 2xl:ml-[60vh] md:text-left absolute text-white">
          <h1 className="mt-2 text-md 2xl:text-[2.5rem]/[3.3rem] md:text-2xl">{textoModificado}</h1>
        </div>
        <div className="absolute mt-36 2xl:ml-[60vh] 2xl:mt-52 2xl:text-3xl md:mt-32 md:my-36 md:ml-80 md:text-left w-full md:w-auto flex flex-wrap md:flex-nowrap justify-center items-center">
